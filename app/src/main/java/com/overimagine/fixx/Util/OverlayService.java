...
public class OverlayService extends Service {
    ...
    class myPhoneStateListener extends PhoneStateListener {
        ...
        public void onCallStateChanged(int state, String incomingNumber) {
            ...
            if (state == 0 || state == 2) {
                OverlayService.this.mView.setVisibility(8);
            }
        }
    }
            ...
            switch (event.getAction()) {
                ...
                case 1:
                    if (!OverlayService.this.isMove) {
                        Toast.makeText(OverlayService.this.getApplicationContext(), "터치됨", 0).show();
                        break;
                    }
    ...
    public void onCreate() {
        ...
        this.mPhoneUtil = new PhoneUtil(getBaseContext());
        ...
        this.Sim1Number = this.mPhoneUtil.getSIM1Number();
        this.Sim2Number = this.mPhoneUtil.getSIM2Number();
        this.settings = getBaseContext().getSharedPreferences("settings", 0);
        this.editor = this.settings.edit();
        this.mManager = (WindowManager) getSystemService("window");
        this.mView = ((LayoutInflater) getSystemService("layout_inflater")).inflate(C0194R.layout.service_overlay, null);
        ...
        this.mParams.x = 0;
        this.mParams.y = -160;
        this.txt_name = (TextView) this.mView.findViewById(C0194R.id.txt_overlay_name);
        this.txt_number = (TextView) this.mView.findViewById(C0194R.id.txt_overlay_number);
